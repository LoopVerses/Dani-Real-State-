...
import { HERO_IMAGE_AREA } from "@/lib/home-layout";
      ...
      >
        ...
        <AnimatePresence initial={false} custom={direction} mode="sync">
          ...
          <motion.div
            ...
            className="absolute inset-0 overflow-hidden will-change-[opacity] bg-[#071E2B] md:will-change-transform"
          ...
          >
            ...
            {isMobile ? (
              ...
              <motion.div
                ...
                className={cn(HERO_IMAGE_AREA, "origin-center")}
